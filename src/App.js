...
function App() {
  ...
  return (
   <div style={{backgroundColor:"#5C8374", minHeight:"100vh", display:"flex", justifyContent:"center"}}>
    <div style={{marginTop:"10vh" , display:"flex", flexDirection:"column", alignItems:"center"}}>
      <h1 style={{color:"#092635"}}>TIRED OF BORING LOREM IPSUM?</h1>
      <div>
        <form onSubmit={pare}>
          <label style={{fontSize:"25px", fontWeight:"bolder", color:"#092635"}}>Paragraph:</label>
          <input style={{border:"none", borderRadius:"5px", padding:"7.5px 15px", marginInline:"15px"}} type="number" id="inp" value={count}  
          onChange = {(e) => setCount(e.target.value)}  />
          <button style={{backgroundColor:"#750E21", color:"white", border:"none", borderRadius:"5px", padding:"8.5px 15px", fontWeight:"bolder" }}
          onClick={()=>{}}>GENERATE</button>
        </form>
      </div>

      
      <div style={{textAlign:"center", marginInline:"5vw", marginTop:"5vh", color:"#6B240C",fontSize:"20px" }}>
          {
          para.map((item, idx) => {
